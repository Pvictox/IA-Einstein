...
popCromossomos = populacao.criarPopulacao(100)
...
pai,probs = operacoes.roletaCromossomo(population=popCromossomos)
popCromossomos.remove(pai)
mae,probs = operacoes.roletaCromossomo(population=popCromossomos)
popCromossomos.append(pai)


print("=========================")
operacoes.crossover(cromossomoPai=pai, cromossomoMae=mae)
